				...
				<div id="main-content">
					<div class="row">
						<div class="col-2-3">
							<div class="wrap-col">
								<div class="contact">
									<h3 style="margin: 20px 0 20px 30px">Авторизация</h3>
									<div id="contact_form">
										<form name="form1" id="ff" method="post" action="afto.php">
											<label class="row">
                                                <div class="col-1-2">
													<div class="wrap-col">
											...
											<center><input class="sendButton" type="submit" name="submit" value="Войти на сайт"></center>
										</form>
									</div>
								</div>
							</div>
