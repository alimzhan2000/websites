					...
					<div class="wrap-content">
						<article>
							<div class="art-header">
								<h3>Baugbekova Almagul Serikovna </h3>
							</div>
							<div class="art-content">
								<img src="images/rab1.jpg" style="width: 50%; height: 300px;"/>
								<p style="font-size: 20px;margin-top: 20px; margin-bottom: 20px;line-height: 2">Former head physician in 1 polyclinic in Almaty <br> PhD on biotechnology and medicine</p>
							</div>
						</article>
						<article>
							<div class="art-header">
								<h3>Inelova Zarina Arkenzhanovna</h3>
							</div>
							<div class="art-content">
								<img src="images/rab2.jpg" style="width: 250px; height: 300px;"/>
								<p style="font-size: 20px;margin-top: 20px; margin-bottom: 20px;line-height: 2">Successfully graduated from the post-graduate course at Stanford University, USA. Worked in the American polyclinic and took an active part in the creation of a medicine for cancer <br> PhD on biotechnology and medicine</p>
							</div>
						</article>
                        <article>
							<div class="art-header">
								<h3>Kudreeva Leila Kadirsizovna </h3>
							</div>
							<div class="art-content">
								<img src="images/rab3.jpg" style="width: 250px; height: 300px;"/>
								<p style="font-size: 20px;margin-top: 20px; margin-bottom: 20px;line-height: 2">Deputy secretary for educational, methodical and educational work <br> PhD on biotechnology and medicine</p>
							</div>
						</article>
					</div>
				</div>
