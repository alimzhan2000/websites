					...
					<div class="wrap-content">
						<article>
							<div class="art-header">
								><h3>Purchase only a glove</h3>
							</div>
							<div class="art-content">
								<img src="images/photoperchatki.JPG" style="width: 100%; height: 600px;"/>
								<p style="font-size: 30px;margin-top: 20px; margin-bottom: 20px;color: black; line-height: 2">Specifications:<br><span5 style="font-size:20px; line-height: 2;">
                                Time of diagnosis: 5 minutes<br>
                                The accuracy of the diagnosis: 42% -84%<br>
                                Operating scheme: UD1408<br></span5>
                                </p>
							</div>
                            <p style="font-size: 50px;margin-top: 20px; margin-bottom: 20px;">Price: 69 000 tenge</p><br>
                            </article>
                            <div id="contact_form">
										<form name="form1" id="ff" method="post" action="ustr2.php">
											<label class="row">
												<div class="col-1-2">
													<div class="wrap-col">
														<input type="text" name="name" id="name" placeholder="Enter your company name" required="required" />
													</div>
												</div>
												<div class="col-1-2">
													<div class="wrap-col">
														<input type="telephone" name="tel" id="name" placeholder="Enter phone number" required="required" />
													</div>
												</div>
											</label>
											<center><input class="sendButton" type="submit" name="submit" value="SEND APPLICATION"></center>
										</form>
									</div>
					</div>
				</div>
