					...
					<div class="wrap-content">
						<article>
							<div class="art-header">
								<h3>Покупка базового пакета устройства(перчатка+браслет) </h3>
							</div>
							<div class="art-content">
								<img src="images/proto.jpeg" style="width: 100%; height: 600px;"/>
								<p style="font-size: 30px;margin-top: 20px; margin-bottom: 20px;color: black; line-height: 2">Технические характеристики:<br><span5 style="font-size:20px; line-height: 2;">
                                Время определения диагноза: 7 минут<br>
                                Точность определения диагноза: 72%-98%<br>
                                    Работающая схема: УД1610<br></span5>
                                </p>
							</div>
                            <p style="font-size: 50px;margin-top: 20px; margin-bottom: 20px;">Цена: 99 000 тенге</p><br>
                            </article>
                            <div id="contact_form">
										<form name="form1" id="ff" method="post" action="ustr.php">
											<label class="row">
												<div class="col-1-2">
													<div class="wrap-col">
														<input type="text" name="name" id="name" placeholder="Введите имя компании" required="required" />
													</div>
												</div>
												<div class="col-1-2">
													<div class="wrap-col">
														<input type="telephone" name="tel" id="name" placeholder="Введите номер телефона" required="required" />
													</div>
												</div>
											</label>
											<center><input class="sendButton" type="submit" name="submit" value="ОТПРАВИТЬ ЗАЯВКУ"></center>
										</form>
									</div>
					</div>
				</div>
