					...
					<div class="wrap-content">
						<article>
							<div class="art-header">
								<h3>Баубекова Алмагуль Сериковна </h3>
							</div>
							<div class="art-content">
								<img src="images/rab1.jpg" style="width: 50%; height: 300px;"/>
								<p style="font-size: 20px;margin-top: 20px; margin-bottom: 20px;line-height: 2">Бывший главный врач в 1 поликлинике города Алматы<br>PhD по биотехнологии и медицине</p>
							</div>
						</article>
						<article>
							<div class="art-header">
								<h3>Инелова Зарина Аркенжановна</h3>
							</div>
							<div class="art-content">
								<img src="images/rab2.jpg" style="width: 250px; height: 300px;"/>
								<p style="font-size: 20px;margin-top: 20px; margin-bottom: 20px;line-height: 2">Успешно закончила доктарантуру в университете "Назарбаев Университет". Работала в американской поликлинике и принимала активное участие в создании лекарства от раковых заболеваний<br>PhD по биотехнологии и медицине</p>
							</div>
						</article>
                        <article>
							<div class="art-header">
								<h3>Кудреева Лейла Кадирсизовна </h3>
							</div>
							<div class="art-content">
								<img src="images/rab3.jpg" style="width: 250px; height: 300px;"/>
								<p style="font-size: 20px;margin-top: 20px; margin-bottom: 20px;line-height: 2">Зам.декана по учебной, методической и воспитательной работе<br>PhD по биотехнологии и медицине</p>
							</div>
						</article>
					</div>
				</div>
