...
-->
					...
					<div class="wrap-content">
						<article>
							<div class="art-header">
								<h3>The main danger of paracetamol</h3>
							</div>
							<div class="art-content">
                                <center>
                                    <img src="images/parac.jpg"style="width: 650px;height:432px;" /></center>
                                <p style="line-height: 2;text-align: justify; text-indent: 40px; margin:left: 20px;margin-right: 20px;color: black;font-size: 18px;">
	The use of drugs based on paracetamol can lead to a violation of reproductive function and problems with fetal development. Relevant data are published in the journal EBioMedicine.
    ...
    American researchers conducted a study in which 455 volunteers over the age of 18 took part, and also analyzed the archival results of a survey of 1,880 European twins and 1,235 people with African American and Spanish roots.
                                </p><p style="color: black;font-size: 18px; line-height: 2;text-align: justify; text-indent: 40px; margin:left: 20px;margin-right: 20px">
Specialists found that in all patients taking paracetamol-based medicines, sexual hormone depletion was observed, equivalent to aging of the body at the hormonal level by 35 years.
                                </p><p style="color: black;font-size: 18px; line-height: 2;text-align: justify; text-indent: 40px; margin:left: 20px;margin-right: 20px">
As noted in the article, this clinical picture can lead to placental dysfunction and impaired sexual function. In addition, the use of paracetamol during pregnancy can lead to problems arising from the development of the nervous system of the embryo.
                                </p><p style="color: black;font-size: 18px; line-height: 2;text-align: justify; text-indent: 40px; margin:left: 20px;margin-right: 20px">
At the same time, the University of California, San Diego noted that the study was carried out by observation and demonstrates only an increased risk of depletion of hormones in patients taking the drug. However, in order to talk about the cause-effect relationship, further clinical trials are needed, in which part of the volunteers will take paracetamol, and others - pacifiers.
                                </p><p style="color: black;font-size: 18px; line-height: 2;text-align: justify; text-indent: 40px; margin:left: 20px;margin-right: 20px">
Paracetamol is a widely used analgesic, which has an antipyretic effect. In Western countries, this drug is known as Acetaminophen (APAP).
</p>
							</div>
						</article>
					</div>
