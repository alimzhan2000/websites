		...
		<header>
			...
			<div id='cssmenu' >
				<ul>
				   ...
				   <li class='last'><a href='contact.php'><span>Где раположены</span></a></li>
						...
						<div class="col-2-3">
							<div class="wrap-col">
								<div class="contact">
									...
									<div id="contact_form">
										<form name="form1" id="ff" method="post" action="registr.php">
											<label class="row">
												<div class="col-1-2">
													<div class="wrap-col">
                                                ...
                                                <div class="col-1-2">
													<div class="wrap-col">
														<input type="text" name="login" id="name" placeholder="Введите логин" required="required" />
													</div>
												</div>
												<div class="col-1-2">
													<div class="wrap-col">
														<input type="password" name="pas1" id="name" placeholder="Введите пароль" required="required" />
													</div>
												</div>
                                                <div class="col-1-2">
													<div class="wrap-col">
														<input type="password" name="pas2" id="name" placeholder="Введите пароль повторно" required="required" />
													</div>
												</div>
											</label>
											<center><input class="sendButton" type="submit" name="submit" value="ЗАРЕГИСТРИРОВАТЬСЯ"></center>
										</form>
									</div>
								</div>
							</div>
